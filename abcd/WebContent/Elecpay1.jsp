...
<!-- /online fonts -->
    ...
    <body>
       ...
       String name = (String)session.getAttribute("lemail");
              String ecus_idp = request.getParameter("ecus_idp");
              String ecus_amount = request.getParameter("ecus_amount");
            
           
              long millis=System.currentTimeMillis();  
              java.sql.Date date=new java.sql.Date(millis);  
             
              String DC= "Electricity Bill";
...
<%
    ...
    String Query2 = "insert into payment values ('"+date+"','"+ecus_amount+"','"+DC+"','"+tid+"','"+ecus_idp+"','"+name+"')";
                                                   // out.println(Query2);  

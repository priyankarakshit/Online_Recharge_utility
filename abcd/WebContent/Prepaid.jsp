...
<!-- /online fonts -->
    ...
    <body>
       ...
       String name = (String)session.getAttribute("lemail");
              String pre_no = request.getParameter("pre_no");
              String pre_operator = request.getParameter("pre_operator");
              String pre_circle = request.getParameter("pre_circle");
              String pre_amount = request.getParameter("pre_amount");
           
              long millis=System.currentTimeMillis();  
              java.sql.Date date=new java.sql.Date(millis);  
             
              String Mobile= "mobile recharge";
...
<%
    ...
    String Query2 = "insert into payment values ('"+date+"','"+pre_amount+"','"+Mobile+"','"+tid+"','"+pre_no+"','"+name+"')";
                                                   // out.println(Query2);  

...
<!-- /online fonts -->
    ...
    <body>
       ...
       String name = (String)session.getAttribute("lemail");
              String Metrono = request.getParameter("Metrono");
              String Metroamount = request.getParameter("Metroamount");
            
           
              long millis=System.currentTimeMillis();  
              java.sql.Date date=new java.sql.Date(millis);  
             
              String Metro= "Metro Recharge";
...
<%
    ...
    String Query2 = "insert into payment values ('"+date+"','"+Metroamount+"','"+Metro+"','"+tid+"','"+Metrono+"','"+name+"')";
                                                   // out.println(Query2);  

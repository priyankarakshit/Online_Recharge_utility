...
<!-- /online fonts -->
    ...
    <body>
       ...
       String name = (String)session.getAttribute("lemail");
              String wcus_idp = request.getParameter("wcus_idp");
              String wcus_amount = request.getParameter("wcus_amount");
            
           
              long millis=System.currentTimeMillis();  
              java.sql.Date date=new java.sql.Date(millis);  
             
              String DC= "Water Bill";
...
<%
    ...
    String Query2 = "insert into payment values ('"+date+"','"+wcus_amount+"','"+DC+"','"+tid+"','"+wcus_idp+"','"+name+"')";
                                                   // out.println(Query2);  

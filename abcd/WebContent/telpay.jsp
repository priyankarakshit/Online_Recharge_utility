...
<!-- /online fonts -->
    ...
    <body>
       ...
       String name = (String)session.getAttribute("lemail");
              String tcus_idp = request.getParameter("tcus_idp");
              String tcus_amount = request.getParameter("tcus_amount");
            
           
              long millis=System.currentTimeMillis();  
              java.sql.Date date=new java.sql.Date(millis);  
             
              String DC= "Landline Bill";
...
<%
    ...
    String Query2 = "insert into payment values ('"+date+"','"+tcus_amount+"','"+DC+"','"+tid+"','"+tcus_idp+"','"+name+"')";
                                                   // out.println(Query2);  

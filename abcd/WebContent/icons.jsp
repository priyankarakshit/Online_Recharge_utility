...
<!-- head -->
<head>
<title>Online Recharge a Corporate Category Bootstrap Responsive Web Template | Icons :: w3layouts</title>
...
<header>
	<div class="container">
		<!--logo-->
			<div class="logo">
				<h1><a href="index.jsp">Online Recharge</a></h1>
			</div>
		<!--//logo-->
...
<!-- breadcrumbs -->
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.jsp"><i class="fa fa-home home_1"></i></a> / <span>Icons</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
		...
		<div class="w3-agile-footer-top-at">
			<div class="col-md-2 agileits-amet-sed">
				...
				<ul class="w3ls-nav-bottom">
					...
					<li><a href="index.jsp#mobileappagileits">Mobile</a></li>	
			...
			<div class="col-md-3 agileits-amet-sed ">
				<h4>Mobile Recharges</h4>
					<ul class="w3ls-nav-bottom">
						<li><a href="index.jsp#parentVerticalTab1">Airtel</a></li>
						<li><a href="index.jsp#parentVerticalTab1">Aircel</a></li>
						<li><a href="index.jsp#parentVerticalTab1">Vodafone</a></li>
						<li><a href="index.jsp#parentVerticalTab1">BSNL</a></li>
						<li><a href="index.jsp#parentVerticalTab1">Tata Docomo</a></li>
						<li><a href="index.jsp#parentVerticalTab1">Reliance GSM</a></li>	
						<li><a href="index.jsp#parentVerticalTab1">Reliance CDMA</a></li>	
						<li><a href="index.jsp#parentVerticalTab1">Telenor</a></li>	
						<li><a href="index.jsp#parentVerticalTab1">MTS</a></li>	
						<li><a href="index.jsp#parentVerticalTab1">Jio</a></li>	
					</ul>	
			</div>
			<div class="col-md-3 agileits-amet-sed ">
				<h4>DATACARD RECHARGES</h4>
				   <ul class="w3ls-nav-bottom">
						<li><a href="index.jsp#parentVerticalTab3">Tata Photon</a></li>
						<li><a href="index.jsp#parentVerticalTab3">MTS MBlaze</a></li>
						<li><a href="index.jsp#parentVerticalTab3">MTS MBrowse</a></li>
						<li><a href="index.jsp#parentVerticalTab3">Airtel</a></li>
						<li><a href="index.jsp#parentVerticalTab3">Aircel</a></li>
						<li><a href="index.jsp#parentVerticalTab3">BSNL</a></li>	
						<li><a href="index.jsp#parentVerticalTab3">MTNL Delhi</a></li>	
						<li><a href="index.jsp#parentVerticalTab3">Vodafone</a></li>	
						<li><a href="index.jsp#parentVerticalTab3">Idea</a></li>	
						<li><a href="index.jsp#parentVerticalTab3">MTNL Mumbai</a></li>
						<li><a href="index.jsp#parentVerticalTab3">Tata Photon Whiz</a></li>	
					</ul>	
			</div>
			<div class="col-md-2 agileits-amet-sed">
				<h4>DTH Recharges</h4>
				<ul class="w3ls-nav-bottom">
						<li><a href="index.jsp#parentVerticalTab2"> Airtel Digital TV Recharges</a></li>
						<li><a href="index.jsp#parentVerticalTab2">Dish TV Recharges</a></li>
						<li><a href="index.jsp#parentVerticalTab2">Tata Sky Recharges</a></li>
						<li><a href="index.jsp#parentVerticalTab2">Reliance Digital TV Recharges</a></li>
						<li><a href="index.jsp#parentVerticalTab2">Sun Direct Recharges</a></li>
						<li><a href="index.jsp#parentVerticalTab2">Videocon D2H Recharges</a></li>	
					</ul>	
			</div>
            <div class="col-md-2 agileits-amet-sed ">
	...
	<div class="w3l-footer-bottom">
		<div class="container-fluid">
			<div class="col-md-4 w3-footer-logo">
				<h2><a href="index.jsp">ONLINE RECHARGE</a></h2>
			</div>
